                            ...
                            <ul className="nav navbar-nav flex-child-menu menu-left">
                                ...
                                <li className="dropdown first">
                                    <a className="btn btn-default dropdown-toggle lv1" data-toggle="dropdown">
                                        ABOUT ME <i className="fa fa-angle-down" aria-hidden="true"></i>
                                    </a>
                                    <ul className="dropdown-menu level1">
                                        <li><a href="blog">SOBRE MI</a></li>
                                    </ul>
                                </li>
                                {/** 
                                <li className="dropdown first">
                            ...
                            <div className="sidebar">
                                ...
                                <div className="sb-twitter sb-it">
                                    ...
                                    <div className="slick-tw">
                                        <div className="tweet item" id="dos">
                                        </div>
                                        <div className="tweet item" id="tres">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container">
                    <div className="flex-parent-ft">
                        ...
                        <div className="flex-child-ft item5">
                            <h4>Newsletter</h4>
                            <p>Subscribe to our newsletter system now <br/> to get the latest news from us.</p>
                            <form action="#">
